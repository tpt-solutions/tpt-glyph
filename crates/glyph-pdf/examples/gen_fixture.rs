...
//
// TPT Glyph — glyph-pdf example
//
// Generates the sample PDF fixture (`fixtures/pdf/hello.pdf`) used by the
// visual-diff harness and by `glyph-pdf` tests. Run with:
//   cargo run -p glyph-pdf --example gen_fixture

use glyph_pdf::document::PdfDocument;
